    ...
    def init_db(self):
        if not os.path.exists(self.db_path):
            ...
            try:
                ...
                # Hashed password with bcrypt: $2b$12$Zp40oTirVshY2e.o2UaQyOfZf77nK1Wz.ZzB1WzTfI6m68YJ74pvi
                admin_id = str(uuid.uuid4())
                admin_email = "admin@bcc.com"
                admin_name = "System Admin"
                admin_pass_hash = "$2b$12$Zp40oTirVshY2e.o2UaQyOfZf77nK1Wz.ZzB1WzTfI6m68YJ74pvi" # bcrypt for admin123
